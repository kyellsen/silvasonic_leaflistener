...
def test_init_analysis_db(mock_db_engine) -> None:
...
def test_run_analysis_nothing_new_to_analyze(mock_db_engine, monkeypatch) -> None:
...
def test_run_analysis_bootstrap(mock_db_engine, monkeypatch) -> None:
...
def test_run_analysis_incremental(mock_db_engine, monkeypatch) -> None:
...
def test_run_analysis_failure(mock_db_engine) -> None:
