    ...
    def from_dict(cls, data: dict, filename: str = "") -> "MicrophoneProfile":
        ...
        return cls(
            ...
            recording=RecordingConfig(
                chunk_duration_seconds=recording_data.get("chunk_duration_seconds", 60),
...
def load_profiles(profiles_dir: Optional[Path] = None) -> list[MicrophoneProfile]:
...
) -> tuple[Optional[MicrophoneProfile], Optional[DetectedDevice]]:
    """
...
def get_active_profile() -> tuple[Optional[MicrophoneProfile], Optional[DetectedDevice]]:
    """
